module github.com/ShadooowX/rayyan-asm
...
replace (
	gopkg.in/check.v1 => ./stubs/gopkg.in/check.v1
	rsc.io/pdf => ./stubs/rsc.io/pdf
)
...
replace nullprogram.com/x/optparse => github.com/skeeto/optparse-go v1.0.0

replace go.uber.org/goleak => github.com/uber-go/goleak v1.3.0
